...
class PTDevicesUnauthorizedError(PTDevicesError):
    """
    The request was denied because the user does not have
    permission to access the device requested.
...
class PTDevicesForbiddenError(PTDevicesError):
    """
    The request was denied because the user does
    You do not have permission to access the device requested
